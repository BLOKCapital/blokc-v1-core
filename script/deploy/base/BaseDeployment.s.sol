...
contract BaseDeployment is Script {
    ...
    function run() public {
        ...
        bytes memory facetRegistryInitData = abi.encodeWithSelector(
            ...
            deployer // msg.sender is the owner for now
        );
        
        ERC1967Proxy facetRegistryProxy = new ERC1967Proxy(
            address(facetRegistryImpl),
            facetRegistryInitData
        );
        ...
        bytes memory poolRegistryInitData = abi.encodeWithSelector(
            ...
            deployer // its the owner for now 
        );
        
        ERC1967Proxy poolRegistryProxy = new ERC1967Proxy(
