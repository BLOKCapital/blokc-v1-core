 ...
 * Ethereum Mainnet. This contract is intended to be inherited by a UniswapV2Facet that exposes the swap functions with
...
abstract contract UniswapV2Base {
    ...
    /// @notice Uniswap V2 Router02 address on Ethereum Mainnet
    ...
    /// @notice Uniswap V2 Factory address on Ethereum Mainnet
    address internal constant UNISWAP_V2_FACTORY_ADDRESS = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
