...
// Local Libraries
import { UniswapV3Base } from "src/garden/facets/utilityFacets/ethereum/uniswapV3/UniswapV3Base.sol";
import { Facet } from "src/garden/facets/Facet.sol";
import { SwapInstruction, QuoteInstruction } from "src/interfaces/ISwapInstruction.sol";

/**
 * @title UniswapV3Facet
 * @notice Facet for Uniswap V3 interactions on Ethereum, enabling token swaps and price oracle queries.
